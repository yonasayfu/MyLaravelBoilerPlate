    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form @submit.prevent="submit" class="space-y-6 p-6">
          ...
          <!-- Staff Information -->
          <div v-if="isStaffSelected || user.staff" class="border-t border-gray-200 dark:border-gray-700 pt-6">
...
const form = useForm({
  ...
  staff: {
    position: props.user.staff?.position || '',
    department: props.user.staff?.department || '',
    hired_at: props.user.staff?.hired_at || '',
    is_active: props.user.staff?.is_active ?? true
  }
})
