...
class MessageService extends PerformanceOptimizedBaseService
{
    ...
    {
        $this->clearCache("conversations_{$user1Id}");
        $this->clearCache("conversations_{$user2Id}");
        $this->clearCache("conversation_messages_{$user1Id}_{$user2Id}_50");
        $this->clearCache("conversation_messages_{$user2Id}_{$user1Id}_50");
        $this->clearCache("last_message_{$user1Id}_{$user2Id}");
        $this->clearCache("last_message_{$user2Id}_{$user1Id}");
        $this->clearCache("unread_count_{$user1Id}");
        $this->clearCache("unread_count_{$user2Id}");
        $this->clearCache("unread_count_{$user1Id}_{$user2Id}");
        $this->clearCache("unread_count_{$user2Id}_{$user1Id}");
    }
