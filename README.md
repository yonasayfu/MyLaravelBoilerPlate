...
- `composer test` or `php artisan test` - Run all tests# Laravel Boilerplate Platform
...
You can extend this boilerplate by adding new modules that follow the same architectural patterns.
- `php artisan test --filter TestName` - Run a specific test
