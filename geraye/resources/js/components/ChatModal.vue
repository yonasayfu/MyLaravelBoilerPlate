      ...
      <div class="flex-grow flex min-h-0"
        ...
        <div v-show="showConversationList || currentWindowWidth >= 768"
          ...
          <div class="p-4 border-b border-gray-200/70 dark:border-gray-700/60 relative">
            ...
            <button v-if="isGroupsTab" @click="showCreateGroupModal = true" class="w-full mb-4 px-4 py-2 text-sm font-medium rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition">Create New Group</button>
            <input
              type="text"
              v-model="search"
